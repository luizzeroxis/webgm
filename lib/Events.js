class Events {
	...
	static listEventTypes = [
		...
		{value: 'step',       name: 'Step',        getFullName: (subtype) => Events.listStepSubtypes[subtype]},
		...
		{value: 'mouse',      name: 'Mouse',       getFullName: (subtype) => Events.listMouseSubtypes[subtype]},
		{value: 'collision',  name: 'Collision',   getFullName: (subtype, project) => 'Collision with '+ (project.resources.ProjectObject.find(x => x.id == subtype).name)},
		{value: 'other',      name: 'Other',       getFullName: (subtype) => Events.listOtherSubtypes[subtype]},
